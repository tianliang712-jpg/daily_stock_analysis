...
STOCK_POOL = {
    "半导体芯片": [
        ("603160","汇顶科技"),("603501","韦尔股份"),("603986","兆易创新"),
        ("300456","赛微电子"),("300458","全志科技"),("300223","晶瑞股份"),
        ("300046","立立电子"),("300102","乾照光电"),("300373","扬杰科技"),
    ],
    "新能源储能": [
        ("002460","赣锋锂业"),("002594","比亚迪"),("300014","亿纬锂能"),
        ("002074","国轩高科"),("300618","寒锐钴业"),("002812","恩捷股份"),
        ("300450","先导智能"),("300274","阳光电源"),("002709","天赐材料"),
    ],
    "AI算力": [
        ("300212","易瑞生物"),("300229","拓尔思"),("300369","宁波环球"),
        ("300017","网宿科技"),("300454","网宿科技"),("002230","科大讯飞"),
    ],
    "机器人自动化": [
        ("300124","汇川技术"),("002472","新时达"),("300403","汉宇集团"),
        ("300195","长荣股份"),("300154","瑞凌股份"),("300280","宁波精密"),
    ],
    "医疗健康": [
        ("300760","迈瑞医疗"),("300529","健帆生物"),("300363","光环新网"),
        ("002223","鱼跃医疗"),("002932","赛康医疗"),("300003","乐普医疗"),
        ("300015","爱尔眼科"),("300347","泰格医药"),("603259","药明康德"),
    ],
    "军工航天": [
        ("600893","航发动力"),("600316","洪都航空"),("600038","中直股份"),
        ("002013","中航机电"),("300034","钢研高纳"),("600862","中航资本"),
    ],
    "消费品牌": [
        ("603288","海天味业"),("603517","绝味食品"),("603605","珀莱雅"),
        ("002507","涪陵榨菜"),("000858","五粮液"),("002304","洋河股份"),
    ],
    "金融科技": [
        ("300059","东方财富"),("600570","恒生电子"),("002195","二三四五"),
        ("300377","赢时胜"),("600036","招商银行"),("601688","华泰证券"),
    ],
    "新材料": [
        ("300285","金力泰"),("002426","胜利精密"),("300408","石英股份"),
        ("002643","万润股份"),("300037","新纶股份"),("002129","中环股份"),
    ],
    "出海跨境": [
        ("002475","富安娜"),("002832","比音勒芬"),("603055","台华新材"),
        ("002293","罗莱生活"),("002563","森马服饰"),("002029","七匹狼"),
    ],
    "光伏风电": [
        ("600438","通威股份"),("002202","金风科技"),("002531","新强联"),
        ("300118","惠程科技"),("300274","阳光电源"),
    ],
    "消费电子": [
        ("002475","立讯精密"),("002351","漫步者"),("002241","歌尔股份"),
        ("300207","欣旺达"),("002045","国光电器"),
    ],
    "农业粮食": [
        ("002311","海大集团"),("002714","牧原股份"),("002124","天邦股份"),
        ("600108","亚盛集团"),("600598","北大荒"),
    ],
    "软件云计算": [
        ("300033","同花顺"),("002065","东华软件"),("002410","广联达"),
        ("300033","同花顺"),("300418","昆仑万维"),
    ],
    "基础设施": [
        ("601390","中国中铁"),("601668","中国建筑"),("600170","上海建工"),
        ("600284","浦东建设"),("002062","宏润建设"),
    ],
}
